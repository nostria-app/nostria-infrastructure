...
module discoveryApp 'modules/container-app.bicep' = {
  ...
  params: {
    ...
    storageAccountKey: listKeys(discoveryStorage.name, '2024-01-01').keys[0].value
    appSettings: [
      {
        name: 'CUSTOM_SETTING'
        value: 'value'
...
module websiteApp 'modules/container-app.bicep' = {
  ...
  params: {
    ...
    storageAccountKey: listKeys(websiteStorage.name, '2024-01-01').keys[0].value
    appSettings: []
  }
}
...
module mainApp 'modules/container-app.bicep' = {
  ...
  params: {
    ...
    storageAccountKey: listKeys(appStorage.name, '2024-01-01').keys[0].value
    appSettings: []
  }
}
...
module relayApps 'modules/container-app.bicep' = [
  for i in range(0, relayCount): {
    ...
    params: {
      ...
      storageAccountKey: listKeys(relayStorage[i].name, '2024-01-01').keys[0].value
    }
  }
]
...
module mediaApps 'modules/container-app.bicep' = [
  for i in range(0, mediaCount): {
    ...
    params: {
      ...
      storageAccountKey: listKeys(mediaStorage[i].name, '2024-01-01').keys[0].value
    }
  }
]
