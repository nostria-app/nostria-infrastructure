...
resource backupStorageAccount 'Microsoft.Storage/storageAccounts@2022-05-01' = {
...
output key string = listKeys(backupStorageAccount.id, backupStorageAccount.apiVersion).keys[0].value