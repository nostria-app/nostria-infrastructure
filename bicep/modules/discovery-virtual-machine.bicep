...
// VM Extension for installing and configuring strfry and Caddy for discovery relay
resource vmExtension 'Microsoft.Compute/virtualMachines/extensions@2023-03-01' = {
  parent: virtualMachine
  name: 'strfry-discovery-setup'
  location: location
  properties: {
    ...
    settings: {
      fileUris: [
        'https://raw.githubusercontent.com/nostria-app/nostria-infrastructure/refs/heads/main/scripts/discovery-vm-setup.sh'
      ]
    }
    protectedSettings: {
      commandToExecute: 'bash discovery-vm-setup.sh ${forceUpdate}'
    }
  }
}
