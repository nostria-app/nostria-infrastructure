...
Write-StatusMessage "Starting Discovery Relay deployment for region: $Region" -Type Info
...
$deploymentName = "nostria-discovery-relay-$Region-$(Get-Date -Format 'yyyyMMdd-HHmmss')"
...
try {
    ...
    & az deployment group create @azParams 2>&1 | Out-Null
